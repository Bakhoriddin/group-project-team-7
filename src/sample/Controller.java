    ...
    public void onStudents() throws Exception {
        ...
        if (!studentAlreadyExists) {
            ...
            while (getStmt.next()) {
                ...
                list.add(new Students(getStmt.getInt("UsersId"), getStmt.getString("FirstName"), getStmt.getString("LastName"), getStmt.getString("Email"), getStmt.getString("Login"), getStmt.getString("Password"), ""));
            }
            for (Students u : list) {
